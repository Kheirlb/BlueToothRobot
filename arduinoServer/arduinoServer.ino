...
SoftwareSerial serial_connection(0, 1);//Create a serial connection with TX and RX on these pins
...
void loop()
{
  ...
  serial_connection.println("Hello Karl");
  //Serial.println("Nothing Available");
  //Serial.println("Hello Karl");
